...
DO $$ BEGIN -- Drop unique index if it exists
...
CREATE UNIQUE INDEX IF NOT EXISTS votes_election_student_candidate_unique ON votes (election_id, student_id, candidate_id);